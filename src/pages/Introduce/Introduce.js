  ...
  return (
    <div>
      <div className="bg-[rgba(0,0,0,0.8)]">
        <img src="./img/introduce/breadcrumb.webp" alt="" />
      </div>
      <div className="w-[1300px] m-auto py-8 px-4">
        <p className="text-4xl mb-4">Giới thiệu</p>
        <div className="flex flex-col gap-4 text-base">
          <div>
            Dola Bakery là một tiệm bánh nằm ẩn mình giữa phố xá nhộn nhịp của
            thành phố. Với bề dày hơn 10 năm kinh nghiệm trong lĩnh vực làm
            bánh, Dola Bakery đã nhanh chóng trở thành điểm đến lý tưởng cho
          ...
          <div>
            Không chỉ chăm chút vào hương vị, Dola Bakery cũng đặc biệt quan tâm
            ...
            phong cách riêng biệt cho Dola Bakery.
          </div>
          <div>
            Khách hàng đã trở thành fan hâm mộ của Dola Bakery không chỉ vì
            những món bánh ngon mà còn vì không gian ấm cúng và thoải mái tại
            tiệm. Với thiết kế sang trọng nhưng cổ điển, Dola Bakery tạo ra một
          ...
          <div>
            Dola Bakery không chỉ đáng để tham quan mà còn là điểm dừng chân lí
            ...
            muốn thưởng thức một chiếc bánh nhỏ đầy mê hoặc, Dola Bakery sẽ luôn
            là sự lựa chọn hàng đầu của bạn.
          </div>
          <div>
            Hãy đến với Dola Bakery và hãy để những món bánh tuyệt vời của chúng
